...
for i in range(1,10):
    ...
    graphCor.SetLineColor(newColor(0.1+i/9.,0.1+(i-5)**2/60.,1.-(i/9.)).GetNumber())
...
histUnfoldedReg.SetMarkerSize(1.6)
histUnfoldedReg.SetMarkerColor(newColor(0.6,0.1,1).GetNumber())
histUnfoldedReg.SetLineColor(newColor(0.6,0.1,1).GetNumber())
