void neyman_t_only_nol()
{
//=========Macro generated from canvas: cv/
//=========  (Mon Apr 24 18:18:18 2017) by ROOT version6.04/16
   ...
   pline->SetPoint(0,0.0751232,0.0586416);
   pline->SetPoint(1,0.1095229,0.100564);
   pline->SetPoint(2,0.1510546,0.148507);
   pline->SetPoint(3,0.1991014,0.201009);
   pline->SetPoint(4,0.251798,0.255466);
   pline->SetPoint(5,0.3060176,0.308405);
   pline->SetPoint(6,0.3578003,0.356133);
   pline->SetPoint(7,0.4030865,0.395522);
   pline->SetPoint(8,0.4383142,0.424508);
   pline->SetPoint(9,0.4607055,0.442093);
   pline->SetPoint(10,0.4683961,0.447969);
   pline->SetPoint(11,0.4273579,0.447969);
   pline->SetPoint(12,0.4194385,0.442093);
   pline->SetPoint(13,0.3964778,0.424508);
   pline->SetPoint(14,0.3606195,0.395522);
   pline->SetPoint(15,0.3149437,0.356133);
   pline->SetPoint(16,0.2632344,0.308405);
   pline->SetPoint(17,0.20965,0.255466);
   pline->SetPoint(18,0.1581226,0.201009);
   pline->SetPoint(19,0.1116634,0.148507);
   pline->SetPoint(20,0.0719857,0.100564);
   pline->SetPoint(21,0.039561,0.0586416);
   pline->SetPoint(22,0.0751232,0.0586416);
   pline->Draw("FSame");
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,0.01828861,0.4869305);
   ...
   graph->Draw("l");
   TMarker *marker = new TMarker(0.0573421,0.0586416,21);
   ...
   marker->Draw();
   marker = new TMarker(0.0907543,0.100564,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.131359,0.148507,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.178612,0.201009,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.230724,0.255466,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.284626,0.308405,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.336372,0.356133,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.381853,0.395522,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.417396,0.424508,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.440072,0.442093,21);
   ...
   marker->SetMarkerSize(1.2);
   marker->Draw();
   marker = new TMarker(0.447877,0.447969,21);
   ...
   pt->SetTextFont(43);
   pt->SetTextSize(34);
   TText *AText = pt->AddText("#mu#kern[-0.5]{ }+#kern[-0.5]{ }jets, t only");
   pt->Draw();
