void /home/users/m/k/mkomm/Diff13/analysis/unfolding/result/nominal/multi_top_pt()
{
//=========Macro generated from canvas: cvMulti0.0111371287873/
//=========  (Mon May 15 15:02:17 2017) by ROOT version6.02/05
   TCanvas *cvMulti0.0111371287873 = new TCanvas("cvMulti0.0111371287873", "",1,1,800,626);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   ...
   TH2F *axis0.5523697814533 = new TH2F("axis0.5523697814533","",50,0,300,50,0,1.8);
   axis0.5523697814533->SetLineStyle(0);
   axis0.5523697814533->SetMarkerStyle(20);
   axis0.5523697814533->SetMarkerSize(0.16);
   axis0.5523697814533->GetXaxis()->SetTitle("top quark p#lower[0.3]{#scale[0.7]{T}} (GeV)");
   axis0.5523697814533->GetXaxis()->SetNdivisions(1005);
   axis0.5523697814533->GetXaxis()->SetLabelFont(43);
   axis0.5523697814533->GetXaxis()->SetLabelOffset(0.0077);
   axis0.5523697814533->GetXaxis()->SetLabelSize(32);
   axis0.5523697814533->GetXaxis()->SetTitleSize(35);
   axis0.5523697814533->GetXaxis()->SetTickLength(0.04032258);
   axis0.5523697814533->GetXaxis()->SetTitleOffset(1.15);
   axis0.5523697814533->GetXaxis()->SetTitleFont(43);
   axis0.5523697814533->GetYaxis()->SetTitle(" Scale factor");
   axis0.5523697814533->GetYaxis()->SetNdivisions(512);
   axis0.5523697814533->GetYaxis()->SetLabelFont(43);
   axis0.5523697814533->GetYaxis()->SetLabelOffset(0.0077);
   axis0.5523697814533->GetYaxis()->SetLabelSize(32);
   axis0.5523697814533->GetYaxis()->SetTitleSize(35);
   axis0.5523697814533->GetYaxis()->SetTickLength(0.03164557);
   axis0.5523697814533->GetYaxis()->SetTitleOffset(1.3);
   axis0.5523697814533->GetYaxis()->SetTitleFont(43);
   axis0.5523697814533->GetZaxis()->SetLabelFont(43);
   axis0.5523697814533->GetZaxis()->SetLabelOffset(0.0077);
   axis0.5523697814533->GetZaxis()->SetLabelSize(32);
   axis0.5523697814533->GetZaxis()->SetTitleSize(34);
   axis0.5523697814533->GetZaxis()->SetTitleOffset(1.3);
   axis0.5523697814533->GetZaxis()->SetTitleFont(43);
   axis0.5523697814533->Draw("AXIS");
   
   TF1 *tf12 = new TF1("tf1","1",0,300);
   tf12->SetFillColor(19);
   tf12->SetFillStyle(0);
   tf12->SetMarkerStyle(20);
   tf12->SetMarkerSize(0.16);
   tf12->SetLineWidth(1);
   tf12->GetXaxis()->SetNdivisions(505);
   tf12->GetXaxis()->SetLabelFont(43);
   tf12->GetXaxis()->SetLabelOffset(0.0077);
   tf12->GetXaxis()->SetLabelSize(32);
   tf12->GetXaxis()->SetTitleSize(34);
   tf12->GetXaxis()->SetTickLength(0.05);
   tf12->GetXaxis()->SetTitleOffset(1.15);
   tf12->GetXaxis()->SetTitleFont(43);
   tf12->GetYaxis()->SetNdivisions(512);
   tf12->GetYaxis()->SetLabelFont(43);
   tf12->GetYaxis()->SetLabelOffset(0.0077);
   tf12->GetYaxis()->SetLabelSize(32);
   tf12->GetYaxis()->SetTitleSize(34);
   tf12->GetYaxis()->SetTitleOffset(1.3);
   tf12->GetYaxis()->SetTitleFont(43);
   tf12->Draw("LSame");
   ...
   TH2F *axis0.552369781453_copy4 = new TH2F("axis0.552369781453_copy4","",50,0,300,50,0,1.8);
   axis0.552369781453_copy4->SetDirectory(0);
   axis0.552369781453_copy4->SetLineStyle(0);
   axis0.552369781453_copy4->SetMarkerStyle(20);
   axis0.552369781453_copy4->SetMarkerSize(0.16);
   axis0.552369781453_copy4->GetXaxis()->SetTitle("top quark p#lower[0.3]{#scale[0.7]{T}} (GeV)");
   axis0.552369781453_copy4->GetXaxis()->SetNdivisions(1005);
   axis0.552369781453_copy4->GetXaxis()->SetLabelFont(43);
   axis0.552369781453_copy4->GetXaxis()->SetLabelOffset(0.0077);
   axis0.552369781453_copy4->GetXaxis()->SetLabelSize(32);
   axis0.552369781453_copy4->GetXaxis()->SetTitleSize(35);
   axis0.552369781453_copy4->GetXaxis()->SetTickLength(0.04032258);
   axis0.552369781453_copy4->GetXaxis()->SetTitleOffset(1.15);
   axis0.552369781453_copy4->GetXaxis()->SetTitleFont(43);
   axis0.552369781453_copy4->GetYaxis()->SetTitle(" Scale factor");
   axis0.552369781453_copy4->GetYaxis()->SetNdivisions(512);
   axis0.552369781453_copy4->GetYaxis()->SetLabelFont(43);
   axis0.552369781453_copy4->GetYaxis()->SetLabelOffset(0.0077);
   axis0.552369781453_copy4->GetYaxis()->SetLabelSize(32);
   axis0.552369781453_copy4->GetYaxis()->SetTitleSize(35);
   axis0.552369781453_copy4->GetYaxis()->SetTickLength(0.03164557);
   axis0.552369781453_copy4->GetYaxis()->SetTitleOffset(1.3);
   axis0.552369781453_copy4->GetYaxis()->SetTitleFont(43);
   axis0.552369781453_copy4->GetZaxis()->SetLabelFont(43);
   axis0.552369781453_copy4->GetZaxis()->SetLabelOffset(0.0077);
   axis0.552369781453_copy4->GetZaxis()->SetLabelSize(32);
   axis0.552369781453_copy4->GetZaxis()->SetTitleSize(34);
   axis0.552369781453_copy4->GetZaxis()->SetTitleOffset(1.3);
   axis0.552369781453_copy4->GetZaxis()->SetTitleFont(43);
   axis0.552369781453_copy4->Draw("sameaxis");
