...
\newcommand{\TAUOLA}{\texttt{Tauola}\xspace}
\newcommand{\PYTHIA}{\texttt{Pythia}\xspace}
\newcommand{\HERWIG}{\texttt{Herwig}\xspace}
\newcommand{\TUNFOLD}{\texttt{TUnfold}\xspace}

\newcommand{\THETA}{\texttt{theta}\xspace}
\newcommand{\ADABOOST}{\texttt{AdaBoost}\xspace}
\newcommand{\GRADIENTBOOST}{\texttt{GradientBoost}\xspace}
