...
\newcommand{\GEANT}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{geant}}\xspace}
\newcommand{\HATHOR}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{hathor}}\xspace}
\newcommand{\POWHEG}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{powheg}}\xspace}
\newcommand{\MG}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{mg}}\xspace}
\newcommand{\AMC}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{amc}}\xspace}
\newcommand{\MGAMC}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{mgamc}}\xspace}
\newcommand{\COMPHEP}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{comphep}}\xspace}
\newcommand{\TAUOLA}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{tauola}}\xspace}
\newcommand{\PHOTOS}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{photos}}\xspace}
\newcommand{\MADSPIN}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{madspin}}\xspace}
\newcommand{\PYTHIA}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{pythia}}\xspace}
\newcommand{\HERWIG}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{herwig}}\xspace}
\newcommand{\SHERPA}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{sherpa}}\xspace}

\newcommand{\TMVA}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{tmva}}\xspace}
\newcommand{\TUNFOLD}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{tunfold}}\xspace}
\newcommand{\THETA}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{theta}}\xspace}
\newcommand{\MINUIT}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{minuit}}\xspace}
\newcommand{\ADABOOST}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{adaboost}}\xspace}
\newcommand{\GRADIENTBOOST}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{gradientboost}}\xspace}
\newcommand{\RIVET}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{rivet}}\xspace}
\newcommand{\TOPFIT}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{topfit}}\xspace}
\newcommand{\TOPFITTER}[1][format=hyperrm]{\texttt{\gls[format=hyperbf,#1]{topfitter}}\xspace}
