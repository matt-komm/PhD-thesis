...
\newcommand{\wboson}{\ensuremath{{\mathrm{W}^\mathrm{\pm}}}\xspace}
\newcommand{\higgs}{\ensuremath{{\mathrm{H}^{0}}}\xspace}

\newcommand{\rmplus}{\ensuremath{\mathrm{\mbox{+}}}}
\newcommand{\rmminus}{\ensuremath{\raisebox{-0.5pt}[0pt][0pt]{$\mathrm{\mbox{-}}$}}}
...
% OTHER
\newcommand{\msbar}{\ensuremath{\overline{\mathit{MS}}}\xspace}
