...
\newcommand{\pvmiss}{\ensuremath{\vec{\slashed{p}}_\mathrm{T}^{\hspace{1px}}}\xspace}
\newcommand{\pvmissx}{\ensuremath{\slashed{p}_{x}^{\hspace{1px}}}\xspace}
\newcommand{\pvmissy}{\ensuremath{\slashed{p}_{y}^{\hspace{1px}}}\xspace}
\newcommand{\pvmissz}{\ensuremath{\slashed{p}_{z}^{\hspace{1px}}}\xspace}
