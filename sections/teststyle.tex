...
\begin{equation}
\sqrt{7\,TeV}=100\,{\rm GeV}+\sqrt{\frac{\sum_{i}\Big(\mathcal{A}-\vec{x}^{2}\Big)_{i}^{\dagger}}{x-y^{3}}}
\end{equation}
...
\lipsum[1]bla blu blub\footnote{bla blu blub.}. Bla blu blub.\lipsum[1]
