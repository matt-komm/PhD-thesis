...
\myfigure[p]{Overview of inclusive (a)~top quark pair and (b)~single top quark cross section measurements by the \gls{atlas}~and \gls{cms}~collaborations at various \acrlong{cm} energies. The figures are taken from the TopLHC working group~\cite{toplhc}.}{
