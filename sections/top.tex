...
\myfigure{ In (a): single-top-quark cross section in $t$ channel for top quarks at $14~\TeV$ as a function of the renormalization and factorization scale $\kappa=\mu/m_\mathrm{t}$. The cross sections have been calculated in 4~and 5~\gls{fs} at \gls{lo} and \gls{nlo}. The figure is taken from Ref.~\cite{Maltoni:2012pa}. In (b): the relative dependence of the strong coupling constant and the b~quark \gls{pdf} (NNPDF3.0) on the scale $\kappa$ with respect to their values at the Z~boson mass.}{
