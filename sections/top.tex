...
\myfigure{\label{fig:theory-t-channel-xsec-fs}Single-top-quark cross section in $t$ channel for top quarks at $14~\TeV$ as a function of the renormalization and factorization scale $\kappa=\mu/m_\mathrm{t}$. The predicted cross sections in 4~and 5~\acrlongpl{fs} at \gls{lo} and \gls{nlo} are shown. The figure is taken from Ref.~\cite{Maltoni:2012pa}}{
