...
With the start of the physics program at the \gls{lhc} in 2009, the production mechanisms of top quarks can be probed with unprecedented precision. This thesis focuses on the production of single top quarks at center-of-mass energies of $8~\TeV$ and $13~\TeV$.
...
%##############################################
\section{Polarization in $t$-channel single-top-quark production}
%##############################################
...
where $D_\mu$ denotes the covariant derivative~(Eq.~\ref{eq:theory-phi-codev}) and the quark field indices refer to the third generation following the notation from Eqs.~\ref{eq:theory-su2-doublets} and~\ref{eq:theory-su2-singlets}. After the electroweak symmetry breaking anomalous couplings can be introduced which absorb all constant terms including $c_{i}(v^2/\Lambda^2)$. One obtains
