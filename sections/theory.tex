...
The cornerstone of such a calculation is the \gls{smatrix} which describes the transition probability of a system from an initial to a final multiparticle state as $|\langle i|\mathcal{S}|f\rangle|^{2}$. In the Heisenberg picture the \gls{smatrix} is given by the Dyson series
