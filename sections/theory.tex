...
is taken between the spin analyzer $X$ in the top quark rest frame and a suitable spin quantization axis $\vec{s}_\mathrm{t}$. Figure~\ref{fig:theory-t-channel-prod-decay} shows a sketch of spin orientations in the top quark rest frame for $t$-channel production and decay. A symmetry between the spectator quark on the production side and the charged lepton on the decay side can be observed. This motivates to choose the spectator quark momentum in the top quark rest frame to quantize the top quark spin. For this axis, a high degree of polarization can be expected. This is due to the fact that the charged lepton is a nearly perfect spin analyzer. Thus the spectator quark momentum is aligned along the top quark spin as well because of the observed symmetry~(see also Tab.~\ref{tab:theory-spin-powers}).


However, for this to be true the spectator quark would have to be down-type.


 since a high polarization along a down-type spectator quark can be expected. This is also derived from the fact that the charged lepton is a nearly perfect spin analyzer~(see Tab.~\ref{tab:theory-spin-powers}). Thus the

\myfigure{\label{fig:theory-t-channel-prod-decay}Sketch of spin orientations in $t$-channel single-top-quark production and decay.}{
