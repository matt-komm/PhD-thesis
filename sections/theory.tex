...
Top quarks can be produced in pairs through strong interactions via gluon or quark fusion. Figure~\ref{fig:test}

\myfigure{logn logn ada aee s f d a sda df sdg sgd fgslfasda das dfsgfsg fg sdfgd fhdfgse  sdf s df sfgfs sdf}{
\subfloat[\label{fig:test}]{\includegraphics[width=0.33\textwidth]{figures/theory/qq2tt_1.pdf}}
\subfloat[]{\includegraphics[width=0.33\textwidth]{figures/theory/qq2tt_2.pdf}}
\subfloat[]{\includegraphics[width=0.33\textwidth]{figures/theory/qq2tt_3.pdf}}
}
