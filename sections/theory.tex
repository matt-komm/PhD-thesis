...
\begin{equation}
\sigma=\sigma_\mathrm{\gls{lo}}\Big(1+\frac{\alpha}{2\pi}\cdot\sigma_\mathrm{1}+\big(\frac{\alpha}{2\pi}\big)^2\cdot\sigma_{1}+\big(\frac{\alpha}{2\pi}\big)^{3}\cdot\sigma_{2}+\ldots\Big).
\end{equation}
...
\myfigure{\label{fig:theory-t-channel-prod-decay}Sketch of spin orientations in $t$-channel single-top-quark production and decay. Figure is inspired from Ref.~\cite{Schwienhorst:2010je}.}{
...
\mytable{\label{tab:theory-singletop-sm-polarization}Expected polarizations of top quarks and top antiquarks in $t$-channel single-top-quark production at $7~\TeV$. Values are taken from Ref.~\cite{Schwienhorst:2010je}.}{
...
In single-top-quark production via $t$ channel, a $\mathrm{b}$~quark is required in the initial state. There are two different ways called 4 and 5~\gls{fs} to treat the $\mathrm{b}$~quark in theoretical calculations. They differ in the number of quark flavors which are included within the proton~\gls{pdf}. Figure~\ref{fig:theory-flavorscheme} shows the Feynam diagram where in 5~\gls{fs} the $\mathrm{b}$~quark originates from the proton but stems from gluon splitting in 4~\gls{fs} instead.

\myfigure{\label{fig:theory-flavorscheme}Feynman diagrams at \gls{lo} for $t$-channel single-top-quark production in 4 and 5~\glsreset{fs}\gls{fs}.}{
\includegraphics[scale=0.75]{figures/theory/flavorscheme.pdf}
}

Since the $\mathrm{b}$~quark mass of $m_\mathrm{b}\approx4.2~\GeV$ is higher than the mass of the proton, $m_\mathrm{p}\approx1~\GeV$, the 4~\gls{fs} seems more natural at first glance. The $\mathrm{b}$~quark is treated as a heavy quark state that decouples completely from the \as and \gls{pdf} evolution through renormalization and the DGLAP equation respectively. However, this approach results in terms proportional to $\propto\log(Q^2/m_\mathrm{b}^2)$ which may prohibit the convergence of perturbative calculations at high energies~\cite{Maltoni:2012pa}.

Such logarithms can be however absorbed into the \gls{pdf}


Both schemes are valid approaches for calculations of observables. The difference and range of validity at fixed order stems from the energy scale at which a process is described. At higher orders both approaches will converge. This is demonstrated in Fig.~\ref{fig:theory-t-channel-xsec-fs} for calculations of the $t$-channel single-top-quark cross section at $14~\TeV$ as a function of the renormalization scale. The dashed curves show the \gls{lo} predictions which are far apart and approach the \gls{nlo} prediction only at low (large) scales for 4~\gls{fs} (5~\gls{fs}) respectively. The \gls{nlo} predictions on the other hand start to converge already at a typical scale of $\mu=m_\mathrm{t}/2$.

\myfigure{\label{fig:theory-t-channel-xsec-fs}Single-top-quark cross section in $t$ channel for top quarks at $14~\TeV$ as a function of the renormalization scale $\kappa=\mu/m_\mathrm{t}$. Shown are the predicted cross sections in 4 and 5~flavor schemes at \gls{lo} and \gls{nlo}. Figure is taken from Ref.~\cite{Maltoni:2012pa}}{
\includegraphics[scale=0.9]{figures/theory/t-channel-xsec-fs}
}

Ratios of 4~\gls{fs} over 5~\gls{fs} differential single-top-quark cross sections as a function of the top quark and spectator jet transverse momentum and pseudo rapidity are shown in Fig.~\ref{fig:theory-t-channel-xsec-fs-diff}. In particular, the top quark \pt shows a nearly linear increasing ratio.

\myfigure{\label{fig:theory-t-channel-xsec-fs-diff}Ratio of 4~\gls{fs}~($\sigma_{2\to3}$) over 5~\gls{fs}~($\sigma_{2\to2}$) differential single-top-quark cross sections in $t$ channel for top quarks at $14~\TeV$ as a function of (a)~the transverse momentum and (b)~the pseudo rapidity of the top quark and light (spectator) jet. Figures are taken from Ref.~\cite{Campbell:2009ss}}{
