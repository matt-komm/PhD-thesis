...
\myfigure{\label{fig:theory-higgs-potential}The ``Mexican hat'' potential of the Higgs field $\phi$ with a non-zero \glshere{vev} $\phi_0$ that leads to symmetry breaking.}{
...
\begin{equation}
\phi(x)\mapsto\phi(x)\cdot\mathrm{e}^{-\tfrac{1}{2}ig\,\alpha_{3}(x)\cdot\omega_{3}}\,\cdot\,\mathrm{e}^{-\tfrac{1}{2}ig^{\prime}\,\beta(x)}\,. \label{eq:theory-broken-u1-trans}
\end{equation}
...
A consequence of electroweak symmetry breaking is the prediction of the Higgs boson. Its mass is not predicted by the \gls{sm} since $\lambda$ is a free parameter of the ``Mexican hat'' potential (Eq.~\ref{eq:theory-higgs-pot}). The Higgs boson was finally discovered in July 2012 independently by the \gls{atlas}~\cite{Aad:2012tfa} and \gls{cms}~\cite{Chatrchyan:2012xdj} collaborations and thus completed the electroweak theory. 
...
\begin{equation}
\mathcal{L}_\mathrm{Yukawa~lepton~int.}\supset-\frac{\lambda_\mathrm{e} v}{\sqrt{2}}\,\mathrm{e}_\mathrm{L}\mathrm{e}_\mathrm{R}-\frac{\lambda_{\mu} v}{\sqrt{2}}\,{\mu}_\mathrm{L}{\mu}_\mathrm{R}-\frac{\lambda_{\tau} v}{\sqrt{2}}\,{\tau}_\mathrm{L}{\tau}_\mathrm{R}+\mathrm{\gls{hc}}
\end{equation}
...
\todo{add uncertainties to the CKM}
...
\todo{make clear that SM w/o Higgs valid below 1 TeV}
