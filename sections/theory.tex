...
\item Parity is not conserved in weak interactions. Such interactions depend on the spin being aligned towards~(``right-handed'') or against~(``left-handed'') the momentum of a particle. Experimentally, the Wu experiment~\cite{PhysRev.105.1413} demonstrated this feature by analyzing the direction of the electron in ${}_{27}^{60}\mathrm{Co}\to{}_{28}^{60}\mathrm{Ni}+e^{-}\bar{\nu}_{e}\gamma\gamma$ decays where the cobalt probe is polarized through a magnetic field. 

\item The UA1 and UA2 experiments at the CERN SPS Proton-Antiproton Collider discovered that the \wboson boson~\cite{Arnison:1983rp,Banner:1983jy} and \zboson boson~\cite{Arnison:1983mk,Bagnaia:1983zx} are massive.

\end{itemize}

The Glawhow-Weinberg-Salam model~\cite{Salam:1964ry,Weinberg:1967tq,Glashow:1961tr}

chirality (-> no mass for fermions anymore), Higgs potential, yukawa interaction, mass term CKM
