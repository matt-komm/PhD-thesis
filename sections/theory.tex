...
\intro{An introduction to the \gls{sm} is given in the following. First its particle content and foundation as a quantum field theory is discussed. Then the interactions are detailed. An brief overview of some open question concluded the chapter.}
