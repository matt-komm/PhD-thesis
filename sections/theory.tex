...
\todo{value of vev from muon decays}
...
where $\mathrm{V}_{ij}$ is the \gls{ckm} matrix. \todo{add matrix from pdg?}
...
%##############################################
matrix elements, cross sections, decays, PDFs, angles (w polarizations)/spin matrix, renormalization?
