...
The confinement of quarks into color-neutral singlets at low energies prevents the experimental determination of the ``free'' quark mass. This is counterintuitive to e.g. the determination of the electron mass which can measured at rest.

Renormalization as briefly described in Sec.~\ref{sec:theory-qcd} provides the means to redefine the mass of a quark at a certain energy scale instead. This procedure is similar the strong coupling constant by absorbing divergent loop corrections as shown in Fig.~.
