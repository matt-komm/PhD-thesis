...
\myfigure{\label{fig:theory-nnpdf-dist}NNPDF3.0 NNLO set in 5 flavor scheme for $\as(m_{\zboson})=0.118$ and factorization scales of (a)~$10~\GeV$ and (b)~$100~\GeV$. The gluon \gls{pdf} has been scaled down by a factor of $0.1$.}{
