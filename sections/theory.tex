...
yields the total momentum of the hadron. The dependence on the energy scale $q$ is given by the DGLAP equations named after authors (Y. Dokshitzer, W. Gribow, L. Lipatow, G. Altarelli, G. Parisi)~\cite{Dokshitzer:1977sg,Gribov:1972ri,Altarelli:1977zs}.
