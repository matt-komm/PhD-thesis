...
\myfigure{\label{fig:theory-lhc-ttbar-xsec}Overview of inclusive \ttbar cross section measurements by the \gls{atlas}~and \gls{cms}~collaborations. Figure is taken from the TopLHC working group.}{
\includegraphics[width=0.99\textwidth]{figures/theory/LHC_ttxsec_sqrts.pdf}
}

\myfigure{}{
\includegraphics[width=0.99\textwidth]{figures/theory/LHC_singletop_allchannels.pdf}
}
...
\myfigure{}{
\includegraphics[width=0.99\textwidth]{figures/theory/LHC_topmass.pdf}
}

\myfigure{}{
\includegraphics[width=0.99\textwidth]{figures/theory/LHC_W_helicity.pdf}
}
