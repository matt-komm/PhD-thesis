...
The top quark can decay via electroweak interaction into on-shell W bosons and a b quark because of its high mass. This leads to a very short lifetime of $1/\Gamma_\mathrm{t}\approx 5\cdot10^{-25}~\mathrm{s}$~\cite{Olive:2016xmw} which is below the typical hadronization timescale of $1/\Lambda_\mathrm{QCD}\approx 10^{-23}~\mathrm{s}$. Hence, the top quark spin orientation is not lost due to soft gluon emission. It can be even reconstructed from the angular distributions of its decay products since electroweak interactions via \wboson exchange feature a \gls{va} coupling structure. This is offers the possibility to study the polarization of top quarks in various \gls{sm} processes and beyond. One can already use top quark decays to study the \wboson boson polarization as well.
