...
The small \gls{sb} ratio motivates the usages \glshere{mva} techniques.

of An observable to separate signal from background events can be obtained from such as \glsplhere{nn} or \glsplhere{bdt}. In this thesis, \glspl{bdt} have been employed to extract the amount of signal events.
