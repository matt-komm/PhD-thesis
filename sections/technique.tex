...
the \GRADIENTBOOST procedure is obtained. This loss function is more robust in the presence of outliers and noise events for which the \ADABOOST algorithm may degrade.

The performance of a trained \gls{bdt} can be assessed using the \glshere{roc} curve.
