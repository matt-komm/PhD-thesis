...
Several corrections have been introduced throughout this chapter to improve the agreement between data and simulation. In the presented analyses within this thesis, the corrections are also considered sources of systematic uncertainties. A summary of corrections and uncertainties is provided in the following.

\begin{description}
\item[Lepton selection] trigger, id, iso,
