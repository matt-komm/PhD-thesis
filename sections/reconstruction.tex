...
Identification of muons for physics analyses is performed by requiring additional selection criteria. The exact criteria differ slightly per data taking period. Here, the details and performance of muon identification and isolation in 2012 pp collision data is briefly discussed. 

Global \gls{pf} muons are selected for analysis with a $\pt$ of at least $26~\GeV$ within a pseudorapidity range of $|\eta|<2.1$. 
