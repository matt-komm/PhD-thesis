...
\todo{describe figure}
\myfigure{\label{fig:reconstruction-btagging}.}{
...
\item[Pileup] The impact of pileup is estimated by varying the inelastic pp cross section which changes the estimated distribution of true pileup interactions in data. The corresponding scale factors are rederived and applied to simulation.
\end{description}
