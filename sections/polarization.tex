...
\item the transverse momentum of the hadronic final-state system, ``$\mathrm{\glsmark{hfs}}~\pt$''\,=~$\big(\vec{p}_{\jprime}+\vec{p}_{\mathrm{b}}\big)_\mathrm{T}$\,.
\end{itemize}
