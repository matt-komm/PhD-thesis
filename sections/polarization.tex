...
\ttbar & $253^{+15}_{-16}~\pb$ && \gls{nnlo} \hfill (using \TOPPP\,2.0~\cite{Czakon:2011xx}) \\
$\mathrm{W}\to\ell\nu\mathrm{\,\mbox{+}\,jets}$ & $12\,234^{+422}_{-416}~\pb$ && \gls{nnlo} \hfill (using \FEWZ~\cite{Gavin:2010az}) \\
$\mathrm{Z}/\gamma^{*}\to\ell^{\rmplus}\ell^{\rmminus}$, $m_{\ell\ell}>50~\GeV$ & $1\,177\pm39~\pb$ && \gls{nnlo} \hfill (using \FEWZ~\cite{Gavin:2010az}) \\
$\mathrm{W}^{\rmplus}~\mathrm{W}^{\rmminus}$ & $54.8\pm3.0~\pb$ && \gls{nlo} \hfill (using \MCFM\,5.8~\cite{Campbell:2010ff})\\
$\mathrm{W}^{\pm}~\mathrm{Z}/\gamma^\star$, $m_{\ell\ell}>12~\GeV$  & $33.2\pm2.7~\pb$ && \gls{nlo} \hfill (using \MCFM\,5.8~\cite{Campbell:2010ff})\\
$\mathrm{Z}/\gamma^\star~\mathrm{Z}/\gamma^\star$, $m_{\ell\ell}>40~\GeV$ & $8.1\pm0.4~\pb$ && \gls{nlo} \hfill (using \MCFM\,5.8~\cite{Campbell:2010ff})\\
\bottomrule
\end{tabular}
}
...
\cmidrule{2-3} 
\cmidrule{5-6}
    & $\mtw>50~\GeV$ & $\bdtqcd>-0.15$ && $\met>45~\GeV$ & $\bdtqcd>0.15$ \\
\midrule
...
\cmidrule{3-6}
\multicolumn{2}{c}{} & \multicolumn{2}{c}{Multijet} & \multicolumn{2}{c}{Others} \\
\midrule
