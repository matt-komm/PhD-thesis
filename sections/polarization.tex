...
The precise determination of the amount of background contributions in the signal region is a vital ingredient for measuring the differential cross section since those needs to be subtracted from data prior to unfolding.

The amount of signal and background contributions are estimated through a two-staged \gls{ml} fit. 
