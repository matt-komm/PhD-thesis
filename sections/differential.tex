...
\begin{tabular}{@{}l c c@{}}
\toprule
Process \hspace{0.5cm}        & \multicolumn{2}{c}{Selection efficiency} \\
\cmidrule{2-3}
                & \hspace{0.2cm}$\muiso<12\%$\hspace{0.2cm}     & \hspace{0.2cm}$\muiso<6\%$\hspace{0.2cm} \\
\midrule
$t$-channel       & 94\%               & 83\% \\
Multijet          & 33\%               & 16\% \\
Other backgrounds & 93\%               & 82\% \\
\bottomrule     
...
\toprule
Process & \hspace{0.1cm}Cross section &\hspace{0.05cm} & Accuracy \\
\midrule
...
\mytablesideways{\label{tab:diff13-aucs}Discrimination power for various event observables and the trained \glspl{bdt} in 2j1t region.}{
\begin{tabular}{@{}l l rr rr rr rr@{}}
\toprule
& Observable \hspace{0.3cm}&  \multicolumn{8}{c }{Area under \gls{roc} curve (\gls{auc})} \\
\cmidrule{3-10}
&  & \multicolumn{2}{c}{\hspace{0.1cm}\ttbar vs. $t$-ch.\hspace{0.2cm}} & \multicolumn{2}{c}{\hspace{0.1cm}\wjets vs. $t$-ch.\hspace{0.2cm}} & \multicolumn{2}{c}{\hspace{0.1cm}multijet vs. $t$-ch.\hspace{0.2cm}} & \multicolumn{2}{c}{\hspace{0.1cm}\ttbar vs. \wjets\hspace{0.5cm}}  \\
\midrule
\multirow{5}{*}{\rotatebox[origin=c]{90}{\gls{bdt} inputs}} 
& Spectator jet $|\eta|$                        &\hspace{0.5cm} \textbf{26\%}&   &\hspace{0.7cm} 21\%&   & \hspace{0.7cm}10\%& &\hspace{0.7cm} 6\%& \\
