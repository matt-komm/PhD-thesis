...
\begin{equation}
\left(\frac{\sigma_\mathrm{\gls{hb}\otimes\gls{he}}}{E}\right)^{2}=\left(\frac{115\%}{\sqrt{E/\GeV}}\right)^{2}+\big(5.5\%\big)^{2}
\end{equation}
...
has measured in electron and pion test beams respectively~\cite{Bayatian:2006jz}.
