...
An additional calorimeter system, the hadron forward calorimeter~(\gls{hf}), is located 11.2~m away from the \gls{ip} at both sides where it covers a pseudorapidity range of $3<|\eta|<5.2$. A different detector technology was chosen for the \gls{hf} to withstand the expected higher levels of radiation of about $1~\mathrm{MGy/a}$ in the forward region. The calorimeter utilizes quarz fibers to detect Cherenkov light from the electromagnetic component of a shower. The fibers are arranged in grooves within steel plates that act as absorbers. Only half of the fibers extend to the complete depth of 165~cm corresponding to 10 interaction lengths. The other half starts at a depths of 22~cm instead. This allows to disentangle electromagnetic from hadronic showers since the former are typically shorter and within 22~cm only.


 to yield a granularity of $\Delta\eta\times\Delta\phi=0.175\times0.175$
