...
\intro{The measurements within this thesis are based on \acrfull{pp} collision data recorded with the \gls{cms} detector in 2012, 2015, and 2016 at \acrlong{cm} energies of 8 and 13~TeV. In this chapter the experimental setup is described. First, an overview of the \gls{lhc}, its preacceleator chain and the experiments at the \gls{lhc} is given. Then, the \gls{cms} detector and its major components are detailed which are: the solenoid magnet, the inner tracking system, the electromagnetic and hadronic calorimeters, and the muon system. The chapter is concluded with a brief overview of the event trigger and data acquisition systems of the \gls{cms} experiment.}
