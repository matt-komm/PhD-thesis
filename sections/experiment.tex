...
In the following, the subcomponents of \gls{cms} are briefly described and their purpose is motivated. More information can be found in Ref.~\cite{Chatrchyan:2008aa}.
...
The solenoid is a crucial part of the \gls{cms} detector. It enables momentum measurements of charged particles by analyzing their curved tracks in the inner barrel by the tracker and in the return flux by the muon systems. Its design was particularly motivated to provide a good resolution of muon momenta and invariant masses in searches for new resonances like the at that time undiscovered Higgs boson decaying to four muons~\cite{Acquistapace:1997fm}. \todo{write better}
...
The inner tracker system is located the closest around the beam pipe.

\myfigure{\label{fig:experiment-tracker}Overview of the \gls{cms} tracking system. The figure is taken from Ref..}{
