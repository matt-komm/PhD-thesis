...
\intro{The measurements within this thesis are based on \glshere{pp} collision data recorded with the \gls{cms} detector in 2012, 2015, and 2016 at \acrlong{cm} energies of 8 and 13~TeV. In this chapter the experimental setup is described. First, an overview of the \gls{lhc}, its preacceleator chain and the experiments at the \gls{lhc} is given. Then, the \gls{cms} detector and its components are detailed. The chapter is concluded with a brief introduction to the trigger and data acquisition system.}
