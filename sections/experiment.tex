...
\includegraphics[width=0.99\textwidth]{figures/experiment/CMS_ecal.pdf}
}

The crystals were chosen for their high density of $8.28~\mathrm{g}/\mathrm{cm}^{3}$ and short radiation length of 0.89~cm. Additional the expected spatial extend of an electromagnetic shower within the crystals is given by the Moli\`ere radius and amounts to only 2.2~cm. This allows for a fine granularity and compact calorimeter. The crystals emitted about 4.5 photoelectrons per \MeV with a wavelength of 420\range430~nm. These are collected by \glspl{apd} in the barrel. In the endcaps \glspl{vpt} are deployed instead which are specifically designed to operated also in the axial magnetic field.
